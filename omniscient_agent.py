...
# define the multi bandit machines
...
bandit = MultiBandit( prob_list=prob_list )
...
for episode in range( episodes ):
    ...
    prob_reward_array += np.true_divide( reward_array, bandit_machine_array )
    accumulated_reward_array.append( accumulated_reward )
    avg_accumulated_reward_array.append( np.mean( accumulated_reward_array ) )

prob_machine_01 = 100*prob_reward_array[0] / episodes
prob_machine_02 = 100*prob_reward_array[1] / episodes
